...
{
    public partial class AddTableHeadersTest : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    header_icon = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    header_field = table.Column<string>(type: "nvarchar(200)", nullable: true),
                    header_type = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    profile_field = table.Column<string>(type: "nvarchar(100)", nullable: true)
                },
                constraints: table =>
                {
