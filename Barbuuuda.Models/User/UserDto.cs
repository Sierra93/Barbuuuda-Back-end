...
namespace Barbuuuda.Models.User {
    ...
    public sealed class UserDto {
        ...
        [Column("user_login", TypeName = "nvarchar(100)")]
        public string UserLogin { get; set; }

        [Column("user_password", TypeName = "nvarchar(100)")]
        ...
        [Column("user_type", TypeName = "nvarchar(50)")]
        public string UserType { get; set; }    // Тип пользователя: Заказчик или Исполнитель.

        [Column("user_phone", TypeName = "nvarchar(100)")]
        ...
        [Column("patronymic", TypeName = "nvarchar(100)")]
        public string Patronymic { get; set; }  // Отчество.

        [Column("token", TypeName = "nvarchar(max)")]
        public string Token { get; set; }   // Токен юзера.

        [Column("user_icon", TypeName = "nvarchar(max)")]
        public string UserIcon { get; set; }    // Путь к иконке пользователя.

        [Column("count_positive", TypeName = "int")]
        public int CountPositive { get; set; }  // Кол-во положительных отзывов исполнителя.

        [Column("count_negative", TypeName = "int")]
        ...
        [Column("is_online", TypeName = "nvarchar(5)")]
        public bool IsOnline { get; set; }

        [Column("date_register", TypeName = "nvarchar(100)")]
